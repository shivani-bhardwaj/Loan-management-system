...
//Shivani Bhardwaj-- Loan Management System
#include<iostream>
#include<conio.h>
#include<fstream>
#include<time.h>
...
float emi_calculator(float p, float r, float t) // TO CALCULATE THE EMI
{ 
    float emi; 
...
int main()
{
    ...
    do
    {
		...
		cin>>k;
             ...
             {
              cout<<"Enter the principal amount and the number of EMI's";
               cin>>principal>>time;
                rate = 12; 
